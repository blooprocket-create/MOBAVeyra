...
- [Pre-Game Client UX Bible v0.1](Docs/Design/Veyra_Pre_Game_Client_UX_Bible_v0.1.md) — approved decisions through UX-92, including a single installed Unreal application with isolated normal-client, Test Skin, champion-select, live-gameplay, verified-results and Reconnect-only states; **paused after UX-92 — do not propose UX-93 until the author says “continue”**
...
- [Settings & Accessibility Bible v0.1](Docs/Design/Veyra_Settings_Accessibility_Bible_v0.1.md) — consolidated player-facing decisions through SET-168; new-feature proposal phase concluded
