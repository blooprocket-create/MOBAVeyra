...
| Map, lanes, jungle, wildlife, towers, Flux Wells, wave schedule and map-spawned objectives | [Battleground Bible](Design/Veyra_Battleground_Bible_v0.9.md) | [Section locator](Index/sections/Veyra_Battleground_Bible_v0.9.md); Combat owns damage/targeting; Vision owns reveal/detection. |
...
| Fog of war, Dense Fog, wards, stealth detection, acquisition | [Vision Bible](Design/Veyra_Vision_Bible_v0.1.md) | Battleground owns map fog placement; Combat owns general targetability and hit validity. |
