...
**Visual language:** A roughly 3m figure — close to twice a person's height — built from dark interlocking iron plates over a molten interior, with a bright orange-white **core spiral** set into the chest. The seams between plates glow, and movement sheds sparks and molten fragments: plates at his extremities ride slightly clear of the body, and broken pieces hang in the air around a raised hand. A heavy cloth drape hangs at the waist, held by iron rings. He draws a long tapering **blade out of his own plating** — the same dark scales with the same molten veining, continuous with the arm. It has no hilt and no forged edge; it is a mass of him tapered to a point. Behind him the Ember Basin: lava running in channels through a burning ruined city. **The metal is his body, not armour worn over something else**: never draw a person, pilot, or face inside the shell, and the blade is drawn from him rather than carried. He is a Forgeheart — an elemental consciousness that formed in the Ember Basin crucibles — **not** a golem, a construct, a Fluxborn, or a transformed human.
