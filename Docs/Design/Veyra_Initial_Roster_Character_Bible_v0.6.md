...
**Eudora's prostheses extended from art (2026-09-21):** Canon specified a single **mechanical left-forearm prosthesis**. Her approved art gives her **both arms from the shoulder and both legs below the knee** — four limbs rather than one forearm — so both her Nature and Visual fields are corrected to match. **This is the largest single change the art has made to a character**, and it leaves a lore question the art cannot answer: one forearm needs no explanation for an engineer, and four limbs implies a specific catastrophe. Her lore already contains a candidate — the night-shift attack, or the bridge her own rivet cannon damaged — but canon never says she was injured in either, and inventing one is the author's call rather than a correction. She remains human: torso, neck and head are flesh. No kit, role, region or roster count changed.  
