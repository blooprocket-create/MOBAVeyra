...
**Neris, two claims withdrawn (2026-09-20):** Her approved art shows her **standing on wet black rock** with the surge breaking over it, so the absolute *"she rides a living wave rather than standing on the ground"* is withdrawn. The wave itself stands — it is her Q and her core fantasy — but it is what she rides, rather than a permanent state she is never seen out of. The guardrail *"not a sea witch"* is also withdrawn as written, because the art's silhouette (wide brim, heavy robes, water conjured from an open hand) now carries that reading. What resists it in the art is her **gear** — the lit lantern, the ship's-wheel medallions, the working chains — so the guardrail is rewritten to protect the gear instead of forbidding the silhouette. **Confirmed by the author (2026-09-20): the art is what they want**, so this is settled rather than provisional. No kit, role, region or roster count changed.  
...
**Visual language:** A rescue rider with long pale blue-white hair and a dark wide-brimmed hat, in a heavy layered coat hung with chains, **ship's-wheel medallions** and working gear, carrying a **lit lantern** that is the warmest thing in the frame. The sea moves with her: luminous ribbons of water lift and curl from her open hand, and the surge breaks white over the black rock at her feet. Her Q rides a living wave, and her **two sea states** show in the water rather than in her — **Calm** is a low steady swell, soft light and an open silhouette; **Storm** raises the surge under her, lifts her higher, darkens the palette and turns it aggressive. Behind her the Drowned Cantons at night: ships at anchor, waterfalls falling through ruined arches, harbour lamps burning. She reads as a mariner rather than an occultist because of what she carries. **Never** strip that gear — the hat and the robes alone collapse her into a sea witch, and she is a rescuer who drowned and came back still working. She is **never** a drowned ghost, and the water is her tool, **not** a monster she commands.
