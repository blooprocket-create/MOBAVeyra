...
- [`Veyra_Pre_Game_Client_UX_Bible_v0.1.md`](Veyra_Pre_Game_Client_UX_Bible_v0.1.md) (approved decisions through UX-92: ordinary client shell, priority matchmaking, committed champion select, Test Skin and one unified Unreal application; **paused after UX-92 until author says “continue”**)
...
**Pre-game client design checkpoint (2026-09-23):** The [Pre-Game Client UX Bible](Veyra_Pre_Game_Client_UX_Bible_v0.1.md) records approved behavior through UX-92, including Test Skin, one installed Unreal client and committed-state transitions. [Client & Platform](Veyra_Client_Platform_Bible_v0.1.md), Parties & Social, Chat and Match Flow retain their respective authority; the [unified-client ADR](../ADR/ADR-004-unified-unreal-client-states.md) records the architectural choice. **Discussion is paused; only resume at UX-93 if the author says “continue”.**
