...
- `Veyra_Client_Platform_Bible_v0.1.md` (website account creation, launcher login/install/patch, one Unreal application with isolated ordinary client, Test Skin, champion-select, gameplay, results, Reconnect-only and replay/spectator states, and trusted-state boundaries)
- [`Veyra_Pre_Game_Client_UX_Bible_v0.1.md`](Veyra_Pre_Game_Client_UX_Bible_v0.1.md) (approved decisions through Proposal 92: ordinary client shell, priority matchmaking, committed champion select, Test Skin and one unified Unreal application; **paused after 92 until author says “continue”**)
...
**Scope of the art-precedence rule:** it applies to each Vanguard's approved **base** illustration at `ConceptArt/Vanguards/<id>/hero.webp`, not their optional costume variants. Alternate skin concepts are indexed in the [cosmetic gallery](../../ConceptArt/Vanguards/skins/README.md) and [skin asset index](../../ConceptArt/Vanguards/skins/index.json) under each Vanguard's `skins/<collection>/hero.webp`. They must not be used to rewrite base appearance canon or replace the image on the generated base Vanguard sheets.

The older baked-text sheets were **deleted on 2026-09-21**, once every Vanguard carried authored hero art and every conflict they raised had been resolved against it. Each Vanguard's YAML records `sheet.status: superseded` with `sheet.file: null` and keeps its `register_refs`, so which sheet carried which conflict is still on record. Three of them had earlier been **withdrawn** for third-party branding and stripped from Git history — a separate status, for a separate reason; see [`../Runbooks/purge-third-party-sheets.md`](../Runbooks/purge-third-party-sheets.md) and [`../../ConceptArt/Archives/`](../../ConceptArt/Archives/).
...
**Pre-game client design checkpoint (2026-09-23):** The [Pre-Game Client UX Bible](Veyra_Pre_Game_Client_UX_Bible_v0.1.md) records approved behavior through Proposal 92, including Test Skin, one installed Unreal client and committed-state transitions. [Client & Platform](Veyra_Client_Platform_Bible_v0.1.md), Parties & Social, Chat and Match Flow retain their respective authority; the [unified-client ADR](../ADR/ADR-004-unified-unreal-client-states.md) records the architectural choice. **Discussion is paused; only resume at Proposal 93 if the author says “continue”.**
