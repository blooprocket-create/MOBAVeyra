...
- `Veyra_Custom_Matches_Bible_v0.1.md` (invite-only sandbox, adjustable rules, uneven/solo matches, selectable AI and invited spectator-only seats with host-selected three-minute or zero-delay viewing)
