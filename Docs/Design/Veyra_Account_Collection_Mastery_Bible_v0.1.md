...
- All client experience states remain in **one Unreal application** per [ADR-004](../ADR/ADR-004-unified-unreal-client-states.md); trusted account/currency/entitlement and authoritative game systems remain separate. **Pre-game UX paused after UX-92** until author “continue”.
