> Repository Markdown edition derived from Veyra Initial Roster Character Bible v0.4. Embedded concept art from the original Word document is omitted.

# Veyra Initial Roster Character Bible

**Version:** 0.4  
**Roster target:** 17 Vanguards  
...
Marek, Neris, Qazharr, and Sylra all connect to the Cantons from very different cultural angles. Sylra adds the Cantons' harbor-pilot and fog-guidance tradition without reducing regional magic to Pactcraft or Wakebound power.
