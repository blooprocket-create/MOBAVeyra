...
is exactly how the old baked-text sheets (deleted 2026-09-21) drifted from
canon.
"""
...
def slot(vid: str, stem: str, label: str, note: str | None, cls: str) -> str:
    ...
    return (f"<div class='slot {cls}'><span class='slot-label'>{html.escape(label)}</span>{sub}"
            f"<span class='slot-file'>{html.escape(stem)}.webp</span></div>")
...
<div class="prov">
  ...
  Generated by <code>render_sheet.py</code>.<br>
