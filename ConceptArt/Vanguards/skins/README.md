...
This index tracks **alternate cosmetic concept artwork**, separately from each Vanguard's canonical `hero.webp`. These six images were supplied by the author on 2026-09-23. They are **concepts only**; no in-game skin, pricing, rarity, effects, animations or release status is implied.
